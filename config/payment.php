...
return [
    ...
    */
    'drivers' => [
        ...
        'novinpal' => [
            'apiPurchaseUrl' => 'https://api.novinpal.ir/invoice/request',
            'apiPaymentUrl' => 'https://api.novinpal.ir/invoice/start/',
            'apiVerificationUrl' => 'https://api.novinpal.ir/invoice/verify',
            'mode' => 'normal', // can be normal, sandbox
            'merchantId' => '',
            'callbackUrl' => 'http://yoursite.com/path/to',
            'description' => 'payment using novinopay',
    ...
    */
    'map' => [
        ...
        'novinopay' => App\Http\Controllers\V1\Gateway\NovinoPay\NovinoPay::class,
        'novinpal' => App\Http\Controllers\V1\Gateway\NovinPal\NovinPal::class,
    ]
];
