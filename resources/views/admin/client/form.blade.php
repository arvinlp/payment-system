...
@section('page_title')
    @if (!isset($data))
        @lang('افزودن مشتری جدید')
    @else
        @lang('ویرایش مشتری :name',['name' => $data->nickname])
    @endif
@endsection
@section('content')
    @if (!isset($data))
        <form action="{{ route('admin.clients.new') }}" method="POST" enctype="multipart/form-data" id="fileUploadForm">
        @else
            <form action="{{ route('admin.clients.edit', ['id' => $id]) }}" method="POST" enctype="multipart/form-data"
                id="fileUploadForm">
    @endif
    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3 mt-3 align-items-center">
                            ...
                            <div class="col-12 col-md-6 text-md-end">
                                <a class="btn btn-sm btn-danger" href="{{ route('admin.clients') }}">
                                    @lang('بازگشت')
                                </a>
                            </div>
                        </div>
